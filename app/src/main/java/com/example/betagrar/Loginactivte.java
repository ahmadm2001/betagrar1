...
public class Loginactivte extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loginactivte);
    ...
    protected void onStart() {
        ...
        Intent si = new Intent(Loginactivte.this, CreditsActivity.class);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(Loginactivte.this, "Login Success", Toast.LENGTH_LONG).show();
                                Intent si = new Intent(Loginactivte.this, CreditsActivity.class);
                                startActivity(si);
                            } else {
                                Log.d("MainActivity", "signinUserWithEmail:fail");
                                Toast.makeText(Loginactivte.this, "e-mail or password are wrong!", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        } else {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                  ...
                  //      pd.dismiss();
                        ...
                        if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                            ...
                            Toast.makeText(Loginactivte.this, "User create failed.", Toast.LENGTH_LONG).show();
                        }
